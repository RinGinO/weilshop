...
export default function AdminBrandEditPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await adminBrandsApi.update(id, { ...formData, id } as any);
      router.push('/admin/brands');
    } catch (error: any) {
  ...
  return (
    <div className="max-w-3xl">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#000000] mb-2">Редактирование бренда</h1>
